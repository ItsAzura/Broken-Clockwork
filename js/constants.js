...
export const STATES = Object.freeze({
    ...
    HEATMAP: 'HEATMAP',
    GAME_OVER: 'GAME_OVER',
    // ─── Daily Challenge states (Requirement 9) ───
    DAILY_CHALLENGE_MENU: 'DAILY_CHALLENGE_MENU',
    DAILY_CHALLENGE_START: 'DAILY_CHALLENGE_START',
    DAILY_CHALLENGE_COMPLETE: 'DAILY_CHALLENGE_COMPLETE',
    DAILY_CHALLENGE_FAILED: 'DAILY_CHALLENGE_FAILED',
    // ─── Level Editor state (Requirement 10) ───
    LEVEL_EDITOR: 'LEVEL_EDITOR',
    LEVEL_EDITOR_PLAYTEST: 'LEVEL_EDITOR_PLAYTEST',
    // ─── Onboarding states (Requirement 19) ───
...
export const TIERED_TAUNTS = {
    ...
    // Lethal Zone / Pit
    lethal_zone: {
        1: ["GRAVITY IS UNFORGIVING.", "THE PIT IS HUNGRY."],
        2: ["WATCH THE EDGE. IT CERTAINLY WATCHES YOU.", "A LONG WAY DOWN FOR A SHORT LIFE."],
        3: ["THE GEARS AT THE BOTTOM ARE WAITING.", "YOU FELL. THE MACHINE DIDN'T."],
        4: ["THERE IS NO SAFETY AT THE BOTTOM."],
    },
};
